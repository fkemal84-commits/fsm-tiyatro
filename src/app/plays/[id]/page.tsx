    ...
    <div className="min-h-screen bg-[var(--bg-dark)] pt-32 pb-24">
      ...
      <div className="relative h-[45vh] min-h-[320px] w-full flex items-end justify-center overflow-hidden border-b border-[var(--border-subtle)]">
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mb-8">
          {play.year && (
            <span className="editorial-tag text-[var(--primary-gold)] inline-block mb-3">
              {play.year}
            </span>
          )}
          <h1 className="serif-font text-4xl sm:text-5xl md:text-6xl text-[var(--text-main)] leading-tight">
            {play.title}
          </h1>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-6 -mt-6 relative z-20">
        <div className="editorial-card p-8 md:p-12 shadow-2xl bg-[var(--bg-surface)]">
          ...
          <div className="flex items-center justify-between pb-6 border-b border-[var(--border-subtle)] mb-8">
            <Link 
              href="/plays" 
              className="text-xs font-bold text-[var(--text-muted)] hover:text-[var(--text-main)] uppercase tracking-wider flex items-center gap-1.5 transition-colors"
            >
