export default function Loading() {
  return (
    <div className="flex flex-col items-center justify-center min-h-[70vh] w-full bg-[var(--bg-dark)]">
      ...
      <h2 className="serif-font text-2xl text-[var(--primary-gold)] animate-pulse">Yükleniyor...</h2>
      <p className="text-[var(--text-muted)] text-sm mt-2 tracking-widest uppercase">FSM Tiyatro</p>
    </div>
  );
}
