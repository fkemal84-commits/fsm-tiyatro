  ...
  return (
    <div className="min-h-screen bg-[var(--bg-dark)] pt-32 pb-24">
      ...
      <div className="max-w-[1380px] mx-auto px-[5%] mb-12">
        <span className="editorial-tag text-[var(--primary-gold)] block mb-2">AJANDA & BULUŞMALAR</span>
        <h1 className="serif-font text-4xl sm:text-5xl md:text-6xl text-[var(--text-main)] mb-3">Etkinlikler</h1>
